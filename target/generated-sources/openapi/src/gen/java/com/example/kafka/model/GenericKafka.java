 ...
 */
@JsonPropertyOrder({
  GenericKafka.JSON_PROPERTY_MESSAGE_ID,
  GenericKafka.JSON_PROPERTY_TIMESTAMP,
  GenericKafka.JSON_PROPERTY_OP_TIMESTAMP,
  GenericKafka.JSON_PROPERTY_SYNC_MSG_ID,
  GenericKafka.JSON_PROPERTY_SOURCE_SERVICE,
  GenericKafka.JSON_PROPERTY_MESSAGE_MODEL_TYPE,
  GenericKafka.JSON_PROPERTY_VERSION,
  GenericKafka.JSON_PROPERTY_AGGREGATE_ID,
  GenericKafka.JSON_PROPERTY_PARTITION_KEY
})
...
public class GenericKafka {
  ...
  public GenericKafka messageId(String messageId) {
  ...
  **/
  ...
  public GenericKafka timestamp(OffsetDateTime timestamp) {
  ...
  **/
  ...
  public GenericKafka opTimestamp(OffsetDateTime opTimestamp) {
  ...
  **/
  ...
  public GenericKafka syncMsgId(String syncMsgId) {
  ...
  **/
  ...
  public GenericKafka sourceService(String sourceService) {
  ...
  **/
  ...
  public GenericKafka messageModelType(MessageModelType messageModelType) {
  ...
  **/
  ...
  public GenericKafka version(String version) {
  ...
  **/
  ...
  public GenericKafka aggregateId(String aggregateId) {
  ...
  **/
  ...
  public GenericKafka partitionKey(String partitionKey) {
  ...
  **/
  ...
  /**
   * Return true if this GenericKafka object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    GenericKafka genericKafka = (GenericKafka) o;
    return Objects.equals(this.messageId, genericKafka.messageId) &&
        Objects.equals(this.timestamp, genericKafka.timestamp) &&
        Objects.equals(this.opTimestamp, genericKafka.opTimestamp) &&
        Objects.equals(this.syncMsgId, genericKafka.syncMsgId) &&
        Objects.equals(this.sourceService, genericKafka.sourceService) &&
        Objects.equals(this.messageModelType, genericKafka.messageModelType) &&
        Objects.equals(this.version, genericKafka.version) &&
        Objects.equals(this.aggregateId, genericKafka.aggregateId) &&
        Objects.equals(this.partitionKey, genericKafka.partitionKey);
  }

  @Override
  public int hashCode() {
    return Objects.hash(messageId, timestamp, opTimestamp, syncMsgId, sourceService, messageModelType, version, aggregateId, partitionKey);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GenericKafka {\n");
