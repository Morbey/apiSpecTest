 ...
 */
@JsonPropertyOrder({
  IpeAudit.JSON_PROPERTY_BPM_TYPE,
  IpeAudit.JSON_PROPERTY_MESSAGE_ID,
  IpeAudit.JSON_PROPERTY_TIMESTAMP,
  IpeAudit.JSON_PROPERTY_OP_TIMESTAMP,
  IpeAudit.JSON_PROPERTY_SYNC_MSG_ID,
  IpeAudit.JSON_PROPERTY_SOURCE_SERVICE,
  IpeAudit.JSON_PROPERTY_MESSAGE_MODEL_TYPE,
  IpeAudit.JSON_PROPERTY_VERSION,
  IpeAudit.JSON_PROPERTY_AGGREGATE_ID,
  IpeAudit.JSON_PROPERTY_PARTITION_KEY,
  IpeAudit.JSON_PROPERTY_AUDIT_TYPE,
  IpeAudit.JSON_PROPERTY_BPM_SPECIFIC_FIELD
})
...
public class IpeAudit {
  ...
  public static final String JSON_PROPERTY_BPM_SPECIFIC_FIELD = "bpmSpecificField";
  private String bpmSpecificField;

  public IpeAudit() { 
  }

  public IpeAudit bpmType(BpmType bpmType) {
  ...
  **/
  ...
  public IpeAudit messageId(String messageId) {
  ...
  **/
  ...
  public IpeAudit timestamp(OffsetDateTime timestamp) {
  ...
  **/
  ...
  public IpeAudit opTimestamp(OffsetDateTime opTimestamp) {
  ...
  **/
  ...
  public IpeAudit syncMsgId(String syncMsgId) {
  ...
  **/
  ...
  public IpeAudit sourceService(String sourceService) {
  ...
  **/
  ...
  public IpeAudit messageModelType(MessageModelType messageModelType) {
  ...
  **/
  ...
  public IpeAudit version(String version) {
  ...
  **/
  ...
  public IpeAudit aggregateId(String aggregateId) {
  ...
  **/
  ...
  public IpeAudit partitionKey(String partitionKey) {
  ...
  **/
  ...
  public IpeAudit auditType(BpmType auditType) {
  ...
  **/
  ...
  public IpeAudit bpmSpecificField(String bpmSpecificField) {
    this.bpmSpecificField = bpmSpecificField;
    return this;
  }

   /**
   * Get bpmSpecificField
   * @return bpmSpecificField
  **/
  @javax.annotation.Nonnull
  @JsonProperty(JSON_PROPERTY_BPM_SPECIFIC_FIELD)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)

  public String getBpmSpecificField() {
    return bpmSpecificField;
  }
  ...
  @JsonProperty(JSON_PROPERTY_BPM_SPECIFIC_FIELD)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setBpmSpecificField(String bpmSpecificField) {
    this.bpmSpecificField = bpmSpecificField;
  }


  /**
   * Return true if this IpeAudit object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    IpeAudit ipeAudit = (IpeAudit) o;
    return Objects.equals(this.bpmType, ipeAudit.bpmType) &&
        Objects.equals(this.messageId, ipeAudit.messageId) &&
        Objects.equals(this.timestamp, ipeAudit.timestamp) &&
        Objects.equals(this.opTimestamp, ipeAudit.opTimestamp) &&
        Objects.equals(this.syncMsgId, ipeAudit.syncMsgId) &&
        Objects.equals(this.sourceService, ipeAudit.sourceService) &&
        Objects.equals(this.messageModelType, ipeAudit.messageModelType) &&
        Objects.equals(this.version, ipeAudit.version) &&
        Objects.equals(this.aggregateId, ipeAudit.aggregateId) &&
        Objects.equals(this.partitionKey, ipeAudit.partitionKey) &&
        Objects.equals(this.auditType, ipeAudit.auditType) &&
        Objects.equals(this.bpmSpecificField, ipeAudit.bpmSpecificField);
  }

  @Override
  public int hashCode() {
    return Objects.hash(bpmType, messageId, timestamp, opTimestamp, syncMsgId, sourceService, messageModelType, version, aggregateId, partitionKey, auditType, bpmSpecificField);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class IpeAudit {\n");
    ...
    sb.append("    bpmSpecificField: ").append(toIndentedString(bpmSpecificField)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `bpmSpecificField` to the URL query string
    if (getBpmSpecificField() != null) {
      joiner.add(String.format("%sbpmSpecificField%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getBpmSpecificField()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
